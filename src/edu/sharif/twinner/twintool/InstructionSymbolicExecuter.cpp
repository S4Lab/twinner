...
void InstructionSymbolicExecuter::addAnalysisRoutine (
  ...
  delete dstexp;
  eflags.setFlags (new AdditionOperationGroup (dstexpOrig, srcexp));
  edu::sharif::twinner::util::Logger::loquacious () << "\tdone\n";
}
...
void InstructionSymbolicExecuter::adcAnalysisRoutine (
  ...
  delete srcexp;
  delete carryexp;
  eflags.setFlags (new DummyOperationGroup ("AdditionWithCarryOperationGroup"));
  edu::sharif::twinner::util::Logger::loquacious () << "\tdone\n";
}
...
void InstructionSymbolicExecuter::subAnalysisRoutine (
  ...
  dst.setExpression (trace, dstexp);
  delete dstexp;
  eflags.setFlags (new SubtractOperationGroup (dstexpOrig, srcexp));
  edu::sharif::twinner::util::Logger::loquacious () << "\tdone\n";
}
...
void InstructionSymbolicExecuter::cmpAnalysisRoutine (
  ...
  eflags.setFlags (new SubtractOperationGroup (dstexp, srcexp));
  edu::sharif::twinner::util::Logger::loquacious () << "\tdone\n";
}
...
void InstructionSymbolicExecuter::shlAnalysisRoutine (
  ...
  delete dstexpOrig;
  delete srcexp;
  eflags.setFlags (new DummyOperationGroup ("ShiftLeftOperationGroup"));
  edu::sharif::twinner::util::Logger::loquacious () << "\tdone\n";
}
...
void InstructionSymbolicExecuter::shrAnalysisRoutine (
  ...
  delete dstexpOrig;
  delete srcexp;
  eflags.setFlags (new DummyOperationGroup ("ShiftRightOperationGroup"));
  edu::sharif::twinner::util::Logger::loquacious () << "\tdone\n";
}
...
void InstructionSymbolicExecuter::sarAnalysisRoutine (
  ...
  delete dstexpOrig;
  delete srcexp;
  eflags.setFlags (new DummyOperationGroup ("ShiftArithmeticRightOperationGroup"));
  edu::sharif::twinner::util::Logger::loquacious () << "\tdone\n";
}
...
void InstructionSymbolicExecuter::andAnalysisRoutine (
  ...
  delete srcexp;
  dst.setExpression (trace, dstexp);
  eflags.setFlags (new BitwiseAndOperationGroup (dstexp));
...
void InstructionSymbolicExecuter::incAnalysisRoutine (
  ...
  delete dstexp;
  delete dstexpOrig;
  eflags.setFlags (new DummyOperationGroup ("IncrementOperationGroup"));
  edu::sharif::twinner::util::Logger::loquacious () << "\tdone\n";
}
...
void InstructionSymbolicExecuter::decAnalysisRoutine (
  ...
  delete dstexp;
  delete dstexpOrig;
  eflags.setFlags (new DummyOperationGroup ("DecrementOperationGroup"));
  edu::sharif::twinner::util::Logger::loquacious () << "\tdone\n";
}

...
private:
  ...
  enum InstructionModel {
    ...
    // there are two (left and right) destinations
    DST_REG_REG_SRC_MEM = 0x0000000800000000,

    DST_REG_SRC_REG_AUX_IMD = 0x0000001000000000,
    DST_REG_SRC_MEM_AUX_IMD = 0x0000002000000000,

    DST_REG_SRC_EITHER_REG_OR_MEM_AUX_IMD =
    DST_REG_SRC_REG_AUX_IMD | DST_REG_SRC_MEM_AUX_IMD,

    DST_REG_REG_SRC_EITHER_REG_OR_MEM =
    ...
    IDIV_INS_MODELS = DST_REG_REG_SRC_EITHER_REG_OR_MEM, /* one operand mode */
  };

...
private:
  ...
  enum InstructionModel {
    ...
    DST_MEM_SRC_LARGE_REG = 0x00080000,

    DST_REG_SRC_REG_AUX_REG = 0x00100000,
    DST_MEM_SRC_REG_AUX_REG = 0x00200000,

    DST_REG_SRC_MUTABLE_REG = 0x00400000,
    DST_MEM_SRC_MUTABLE_REG = 0x00800000,

    STRING_OPERATION_REG_MEM = 0x01000000, // MEM is implicit [rdi]
    STRING_OPERATION_MEM_MEM = 0x02000000, // MEMs are implicit [rdi] and [rsi]

    LEAVE_INS_MODELS = 0x04000000,

    DST_LARGE_REG_SRC_REG = 0x08000000,

    DST_LARGE_REG_SRC_LARGE_REG_AUX_IMD = 0x10000000,
    DST_LARGE_REG_SRC_MEM_AUX_IMD = 0x20000000,

...
private:
  ...
  enum InstructionModel {
    ...
    STRING_OPERATION_MEM_MEM = 0x0000000008000000, // MEMs are implicit [rdi] and [rsi]

    LEAVE_INS_MODELS = 0x0000000010000000,

    DST_LARGE_REG_SRC_REG = 0x0000000020000000,

    DST_LARGE_REG_SRC_LARGE_REG_AUX_IMD = 0x0000000040000000,
    DST_LARGE_REG_SRC_MEM_AUX_IMD = 0x0000000080000000,

    DST_REG_SRC_MEM_AUX_RSI = 0x0000000100000000,

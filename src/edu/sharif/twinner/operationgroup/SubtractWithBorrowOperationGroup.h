...
#ifndef SUBTRACT_WITH_BORROW_OPERATION_GROUP_H
#define SUBTRACT_WITH_BORROW_OPERATION_GROUP_H
...
class SubtractWithBorrowOperationGroup : public NaryOperationGroup<3> {
public:
  SubtractWithBorrowOperationGroup (ConstExpressionPtr mainExp,
...
#endif /* SubtractWithBorrowOperationGroup.h */

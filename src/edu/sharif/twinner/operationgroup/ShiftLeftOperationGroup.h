...
#ifndef SHIFT_LEFT_OPERATION_GROUP_H
#define SHIFT_LEFT_OPERATION_GROUP_H
...
class ShiftLeftOperationGroup : public NaryOperationGroup<2> {
public:
  ShiftLeftOperationGroup (ConstExpressionPtr mainExp,
...
#endif /* ShiftLeftOperationGroup.h */

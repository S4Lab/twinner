...
class ArithmeticShiftRight : public Operator {

public:
  ArithmeticShiftRight ();
  ArithmeticShiftRight (const ArithmeticShiftRight &ao);
  virtual ~ArithmeticShiftRight ();

  virtual ArithmeticShiftRight *clone () const;

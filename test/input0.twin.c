		...
		if (cond_2 (UINT64 (argv[1][0]))) {
			if (cond_3 (UINT64 (argv[1][1]))) {
				if (cond_4 (UINT64 (argv[1][2]))) {
					...
					*((UINT64 *) 0x7fffffffe290) = UINT64 (((((signExtend_0x20_0x8 (argv[1][0]) - 0x30) << 0x20) & 0xffffffff00000000) | m7fffffffe290_0_32) /*0xffffe380*/);
					*((UINT64 *) 0x7fffffffe298) = UINT64 (((((signExtend_0x20_0x8 (argv[1][2]) - 0x30) << 0x20) & 0xffffffff00000000) | ((signExtend_0x20_0x8 (argv[1][1]) - 0x30) & 0xffffffff)) /*0x2*/);
					*((UINT64 *) 0x7fffffffe2a0) = UINT64 (rbp_0 /*0x0*/);
					*((UINT64 *) 0x7fffffffe2a8) = UINT64 (m7fffffffe2a8_0_64 /*0x7ffff5fe6f45*/);

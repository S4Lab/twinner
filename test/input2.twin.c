...
SAVE_REGISTERS (regs);
	...
	*((UINT64 *) 0x7fffffffe248) = 0x7ffff5ff3f45;
	...
	if ((((UINT64 (rsp_0) + 0xffff800000001db8) & 0xffffffffffffffff) /*0x0*/ == 0)) {
		if ((/*signed {*/UINT128 (0x0, 0x0, 0x0, 0x2)/*}*/ < /*signed {*/signExtend_0x80_0x20 ((UINT64 (rdi_0) & 0xffffffff)) /*UINT128 (0x0, 0x0, 0x0, 0x3)*//*}*/)) {
			if ((((UINT64 (rsi_0) + 0xffff800000001cd8) & 0xffffffffffffffff) /*0x0*/ == 0)) {
				...
				*((UINT64 *) 0x7fffffffe330) = UINT64 (argv[1] /*0x7fffffffe564*/);
				/*Registers Changes*/
				...
				regs.rbp = UINT64 (((rsp_0 - 0x8) & 0xffffffffffffffff) /*0x7fffffffe240*/);
				regs.rax = strcmp (/*"--wrongopt"*/ (const char *) argv[1] /*0x7fffffffe564*/, /*"--option"*/ (const char *) 0x4006b7);

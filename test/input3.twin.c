...
if (cond_11 (n_v_argv_2_0, n_v_argv_4_0)) {
		...
		*((UINT64 *) 0x7fffffffe240) = UINT64 (rbp_0 /*0x0*/);
		/*Registers Changes*/
		regs.rax = UINT64 ((((signExtend_0x20_0x8 (n_v_argv_4_0) - 0x30) + (signExtend_0x20_0x8 (n_v_argv_2_0) - 0x30)) & 0xffffffff) /*0x3*/);
...
SAVE_REGISTERS (regs);
	...
	*((UINT32 *) 0x7fffffffe228) = 0x400490;
	*((UINT64 *) 0x7fffffffe230) = 0x7fffffffe320;
	*((UINT32 *) 0x7fffffffe23c) = 0x0;
	*((UINT64 *) 0x7fffffffe248) = 0x7ffff5fe7f45;
  ...
  const UINT64 m7fffffffe330_0_64 = *((UINT64 *) 0x7fffffffe330);
	if ((/*signed {*/UINT128 (0x0, 0x0, 0x0, 0x4)/*}*/ < /*signed {*/signExtend_0x80_0x20 ((UINT64 (rdi_0) & 0xffffffff)) /*UINT128 (0x0, 0x0, 0x0, 0x5)*//*}*/)) {
		...
		*((UINT64 *) 0x7fffffffe240) = UINT64 (rbp_0 /*0x0*/);
		*((UINT64 *) 0x7fffffffe248) = UINT64 (m7fffffffe248_0_64 /*0x7ffff5fe7f45*/);
		*((UINT64 *) 0x7fffffffe330) = UINT64 (argv[1] /*0x7fffffffe56c*/);
		...
		regs.rsp = UINT64 (((rsp_0 - 0x28) & 0xffffffffffffffff) /*0x7fffffffe220*/);
		regs.rbp = UINT64 (((rsp_0 - 0x8) & 0xffffffffffffffff) /*0x7fffffffe240*/);
		regs.rax = strcmp (/*"--left"*/ (const char *) m7fffffffe330_0_64 /*0x7fffffffe56c*/, /*"--left"*/ (const char *) 0x4007d4);
			...
			if ((UINT64 (argv[2][1]) /*0x0*/ == 0)) {
				if ((/*signed {*/UINT128 (0x0, 0x0, 0x0, 0x2f)/*}*/ < /*signed {*/signExtend_0x80_0x8 (UINT64 (argv[2][0])) /*UINT128 (0x0, 0x0, 0x0, 0x33)*//*}*/)) {
					if ((/*signed {*/UINT128 (0x0, 0x0, 0x0, 0x39)/*}*/ >= /*signed {*/signExtend_0x80_0x8 (UINT64 (argv[2][0])) /*UINT128 (0x0, 0x0, 0x0, 0x33)*//*}*/)) {
						...
						*((UINT64 *) 0x7fffffffe340) = UINT64 (m7fffffffe340_1_64 /*0x7fffffffe575*/);
						/*Registers Changes*/
						regs.rax = UINT64 (rax_1 /*0x0*/);
						regs.rdi = UINT64 (m7fffffffe340_1_64 /*0x7fffffffe575*/);
						regs.rsi = UINT64 (0x400807);
						regs.rsp = UINT64 (((rsp_0 - 0x28) & 0xffffffffffffffff) /*0x7fffffffe220*/);
						regs.rbp = UINT64 (((rsp_0 - 0x8) & 0xffffffffffffffff) /*0x7fffffffe240*/);
						regs.rax = strcmp (/*"--right"*/ (const char *) m7fffffffe340_1_64 /*0x7fffffffe575*/, /*"--right"*/ (const char *) 0x400807);
								...
								if ((/*signed {*/UINT128 (0x0, 0x0, 0x0, 0x2f)/*}*/ < /*signed {*/signExtend_0x80_0x8 (UINT64 (argv[4][0])) /*UINT128 (0x0, 0x0, 0x0, 0x35)*//*}*/)) {
									if ((/*signed {*/UINT128 (0x0, 0x0, 0x0, 0x39)/*}*/ >= /*signed {*/signExtend_0x80_0x8 (UINT64 (argv[4][0])) /*UINT128 (0x0, 0x0, 0x0, 0x35)*//*}*/)) {
										if (cond_10 (UINT64 (argv[2][0]), UINT64 (argv[4][0]))) {
											...
											*((UINT64 *) 0x7fffffffe220) = UINT64 (rsi_0 /*0x7fffffffe328*/);
											*((UINT64 *) 0x7fffffffe230) = UINT64 (m7fffffffe230_1_64 /*0x7fffffffe320*/);
											*((UINT64 *) 0x7fffffffe238) = UINT64 (((((signExtend_0x20_0x8 (argv[4][0]) - 0x30) << 0x20) & 0xffffffff00000000) | ((signExtend_0x20_0x8 (argv[2][0]) - 0x30) & 0xffffffff)) /*0x3*/);
											*((UINT64 *) 0x7fffffffe240) = UINT64 (rbp_0 /*0x0*/);
											*((UINT64 *) 0x7fffffffe348) = UINT64 (m7fffffffe348_2_64 /*0x7fffffffe57d*/);
											/*Registers Changes*/
